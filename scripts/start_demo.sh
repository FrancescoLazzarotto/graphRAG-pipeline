...
#
#   scripts/start_demo.sh                     # default generator + encoder + UI
#   scripts/start_demo.sh --list              # what can be served
#   scripts/start_demo.sh qwen25-32b qwen25-7b
#   scripts/start_demo.sh qwen25-72b --no-ui  # both GPUs, no browser UI
#
...
echo "== preflight =="
conda run -n "$CONDA_ENV" python "$ROOT/scripts/smoke_check.py" \
...
echo
echo "Tutto su. Per fermare: scripts/stop_demo.sh"
